...
import StockItemAutocomplete from '../stock-item-autocomplete'

type RhfStockItemAutocompleteProps = {
...
const RhfStockItemAutocomplete: React.FC<RhfStockItemAutocompleteProps> = ({
  noOptionFoundString,
  inputClass,
  labelClass,
  divClass,
        ...
        return (
          <div className={divClass}>
            <StockItemAutocomplete
              ...
              shopId={shopId}
              multiple={multiple}
              targetType={targetType} // freeSolo={freeSolo} // Set to true if you want to allow free input
            />
            {fieldState.error && (
...
export default RhfStockItemAutocomplete
